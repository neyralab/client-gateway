...
var downloadFile = function (currentFile, oneTimeToken, signal, endpoint) { return __awaiter(void 0, void 0, void 0, function () {
    var slug, chunkCountResponse, res, count, chunks, index, encryptedChunk, file;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, (0, index_1.downloadChunk)(index, null, slug, oneTimeToken, signal, endpoint)];
            case 4:
                encryptedChunk = _a.sent();
