...
var loadFileFromSP_1 = require("./loadFileFromSP");
var downloadFile = function (_a) {
    var file = _a.file, oneTimeToken = _a.oneTimeToken, endpoint = _a.endpoint, isEncrypted = _a.isEncrypted, key = _a.key, callback = _a.callback, handlers = _a.handlers, signal = _a.signal, carReader = _a.carReader;
    return __awaiter(void 0, void 0, void 0, function () {
        var isFileFromSP, startTime, chunks, totalProgress, fileStream, fileBlob, entry_clientside_key, slug, sha3, chunkCountResponse, count, Readable, index, chunk, downloadedChunk, bufferKey, file_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    isFileFromSP = file.is_on_storage_provider;
                    startTime = Date.now();
                    chunks = [];
                    totalProgress = { number: 0 };
                    fileStream = null;
                    if (!isFileFromSP) return [3 /*break*/, 2];
                    return [4 /*yield*/, (0, loadFileFromSP_1.loadFileFromSP)({
                            carReader: carReader,
                            type: file.mime,
                            url: "".concat(file.storage_provider.url, "/").concat(file.fileicon_hash),
                        })];
                case 1:
                    fileBlob = _b.sent();
                ...
                case 5:
                    ...
                    if (!!isEncrypted) return [3 /*break*/, 6];
