...
exports.cancelingDownload = exports.downloadFile = void 0;
...
var downloadFile = function (_a) {
    var file = _a.file, oneTimeToken = _a.oneTimeToken, endpoint = _a.endpoint, isEncrypted = _a.isEncrypted, key = _a.key, callback = _a.callback, handlers = _a.handlers;
    return __awaiter(void 0, void 0, void 0, function () {
        var startTime, controller, chunks, totalProgress, fileStream, entry_clientside_key, slug, sha3, chunkCountResponse, count, Readable, index, chunk, downloadedChunk, bufferKey, file_1;
...
var cancelingDownload = function (slug) {
    if (fileControllers[slug]) {
        fileControllers[slug].abort();
    }
    else
        cancelledFiles.add(slug);
};
exports.cancelingDownload = cancelingDownload;
