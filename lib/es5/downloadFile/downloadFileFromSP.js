...
function saveFileFromGenerator(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var prev, chunk, e_2_1, blob, bufferKey, chunks, _j, _k, _l, _m, chunk, chunkArrayBuffer, decryptedChunk, e_3_1, bufferKey, decryptedChunk, _o;
        var _p, _q, _r;
        var _this = this;
        return __generator(this, function (_s) {
            switch (_s.label) {
                ...
                case 26: return [2 /*return*/, (0, joinChunks_1.joinChunks)(chunks)];
                case 27:
                    if (!(isEncrypted && level === 'upload')) return [3 /*break*/, 30];
                    bufferKey = (0, convertBase64ToArrayBuffer_1.convertBase64ToArrayBuffer)(key);
                    _o = decryptChunk_1.decryptChunk;
                    _r = {};
                    return [4 /*yield*/, blob.arrayBuffer()];
                ...
                case 29:
                    decryptedChunk = _s.sent();
                    return [2 /*return*/, (0, joinChunks_1.joinChunks)([decryptedChunk])];
