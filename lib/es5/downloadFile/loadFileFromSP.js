...
exports.loadFileFromSP = void 0;
var ipfs_unixfs_exporter_1 = require("ipfs-unixfs-exporter");
function loadFileFromSP(_a) {
    var carReader = _a.carReader, type = _a.type, url = _a.url;
                    ...
                    return __generator(this, function (_e) {
                        switch (_e.label) {
                            ...
                            case 4:
                                ...
                                cont = entry.content();
                                return [4 /*yield*/, saveFileFromGenerator({ generator: cont, type: type })];
                            case 5:
                                fileBlob = _e.sent();
...
exports.loadFileFromSP = loadFileFromSP;
function saveFileFromGenerator(_a) {
    var _b, generator_1, generator_1_1;
    var _c, e_2, _d, _e;
    var generator = _a.generator, type = _a.type;
    return __awaiter(this, void 0, void 0, function () {
        var prev, chunk, e_2_1, blob;
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 3:
                    if (!(generator_1_1 = _f.sent(), _c = generator_1_1.done, !_c)) return [3 /*break*/, 5];
