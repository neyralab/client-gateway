...
var sendChunk = function (_a) {
    var chunk = _a.chunk, index = _a.index, file = _a.file, startTime = _a.startTime, oneTimeToken = _a.oneTimeToken, endpoint = _a.endpoint, iv = _a.iv, clientsideKeySha3Hash = _a.clientsideKeySha3Hash, totalProgress = _a.totalProgress, callback = _a.callback, handlers = _a.handlers, controller = _a.controller, totalSize = _a.totalSize;
    return __awaiter(void 0, void 0, void 0, function () {
        var base64iv, xHash, fileName, chunksLength, currentTry, cookieJar, headers, uploadChunk;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    base64iv = iv ? Base64.fromByteArray(iv) : null;
                    xHash = (0, createSHA256Hash_1.createSHA256Hash)(chunk);
                    fileName = (0, convertTextToBase64_1.convertTextToBase64)(file.name);
                    chunksLength = Math.ceil(file.size / config_1.CHUNK_SIZE);
                    currentTry = 1;
                    cookieJar = [];
                    headers = {
                    ...
                    uploadChunk = function (chunk) { return __awaiter(void 0, void 0, void 0, function () {
                        var response, prevProgress, progress, elapsedTime, size, remainingBytes, bytesPerMillisecond, remainingTime, timeLeft, error_1, isNetworkError, is502or504Error;
                        var _a, _b, _c;
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 2:
                                    _d.trys.push([2, 6, , 7]);
                                    response = void 0;
                                    if (!!(0, isBrowser_1.isBrowser)()) return [3 /*break*/, 3];
                                    response = axios_1.default
                                        ...
                                        .then(function () {
                                        return (0, makeRequestWithCookies_1.postWithCookies)("".concat(endpoint, "/chunked/uploadChunk"), headers, cookieJar, controller ? controller.signal : undefined, chunk);
                                    })
                                        .catch(function (error) {
                                        console.log("Error:", error);
                                    });
                                    return [3 /*break*/, 5];
                                case 3: return [4 /*yield*/, axios_1.default.post("".concat(endpoint, "/chunked/uploadChunk"), chunk, {
                                        headers: headers,
                                ...
                                case 6:
                                    ...
                                    is502or504Error = ((_b = error_1 === null || error_1 === void 0 ? void 0 : error_1.response) === null || _b === void 0 ? void 0 : _b.status) === 502 || ((_c = error_1 === null || error_1 === void 0 ? void 0 : error_1.response) === null || _c === void 0 ? void 0 : _c.status) === 504;
                                    if (currentTry >= (is502or504Error ? config_1.MAX_TRIES_502 : config_1.MAX_TRIES) ||
