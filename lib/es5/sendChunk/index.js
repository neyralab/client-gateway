...
var makeRequestWithCookies_1 = require("../utils/makeRequestWithCookies");
var isMobile_1 = require("../utils/isMobile");
var isBrowser_1 = require("../utils/isBrowser");
var createSHA256Hash_1 = require("../utils/createSHA256Hash");
var File_1 = require("../types/File");
var config_1 = require("../config");
var sendChunk = function (_a) {
    var chunk = _a.chunk, index = _a.index, file = _a.file, startTime = _a.startTime, oneTimeToken = _a.oneTimeToken, gateway = _a.gateway, iv = _a.iv, clientsideKeySha3Hash = _a.clientsideKeySha3Hash, totalProgress = _a.totalProgress, callback = _a.callback, handlers = _a.handlers, controller = _a.controller, totalSize = _a.totalSize;
    return __awaiter(void 0, void 0, void 0, function () {
        var base64iv, xHash, fileName, fileSize, chunksLength, currentTry, cookieJar, headers, uploadChunk;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    base64iv = iv ? Base64.fromByteArray(iv) : null;
                    xHash = (0, isMobile_1.isMobile)() ? 'null' : (0, createSHA256Hash_1.createSHA256Hash)(chunk);
                    ...
                    chunksLength = Math.ceil(fileSize / gateway.upload_chunk_size);
                    currentTry = 1;
                    cookieJar = [];
                    headers = {
                    ...
                    if (file instanceof File_1.LocalFileReactNativeStream) {
                    ...
                    uploadChunk = function (chunk) { return __awaiter(void 0, void 0, void 0, function () {
                        var response, prevProgress, chunkLength, progress, elapsedTime, size, remainingBytes, bytesPerMillisecond, remainingTime, timeLeft, error_1, isNetworkError, isOtherError;
                        var _a, _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 2:
                                    _c.trys.push([2, 6, , 7]);
                                    response = void 0;
                                    if (!(!(0, isBrowser_1.isBrowser)() && !(0, isMobile_1.isMobile)())) return [3 /*break*/, 3];
                                    response = axios_1.default
                                        .get("".concat(gateway.url), {
                                        headers: {
                                            'content-type': 'application/octet-stream',
                                            'one-time-token': oneTimeToken,
                                        },
                                        ...
                                        .then(function () {
                                        return (0, makeRequestWithCookies_1.postWithCookies)("".concat(gateway.url, "/chunked/uploadChunk"), headers, cookieJar, controller ? controller.signal : undefined, chunk);
                                    })
                                        .catch(function (error) {
                                        console.log('Error:', error);
                                    });
                                    return [3 /*break*/, 5];
                                case 3: return [4 /*yield*/, axios_1.default.post("".concat(gateway.url, "/chunked/uploadChunk"), chunk, {
                                        headers: headers,
                                ...
                                case 5:
                                    ...
                                    chunkLength = typeof chunk === 'string' ? (chunk.length * 3) / 4 : chunk.byteLength;
                                    progress = +prevProgress + chunkLength;
                                    totalProgress.number = progress;
                                    elapsedTime = Date.now() - startTime;
                                    size = totalSize || file.size;
                                    remainingBytes = size - progress;
                                ...
                                case 6:
                                    ...
                                    isOtherError = config_1.ERRORS.includes((_b = error_1 === null || error_1 === void 0 ? void 0 : error_1.response) === null || _b === void 0 ? void 0 : _b.status);
                                    if (currentTry >= (isOtherError ? config_1.MAX_TRIES_502 : config_1.MAX_TRIES) ||
