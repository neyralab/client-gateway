...
var sendChunk = function (_a) {
    var chunk = _a.chunk, index = _a.index, chunksLength = _a.chunksLength, file = _a.file, startTime = _a.startTime, oneTimeToken = _a.oneTimeToken, endpoint = _a.endpoint, iv = _a.iv, clientsideKeySha3Hash = _a.clientsideKeySha3Hash, totalProgress = _a.totalProgress, callback = _a.callback, handlers = _a.handlers;
    return __awaiter(void 0, void 0, void 0, function () {
        var base64iv, fileName, currentTry, cookieJar, headers, uploadChunk;
                            ...
                            switch (_b.label) {
                                ...
                                case 2:
                                    ...
                                    response = axios_1.default
                                        ...
                                        .then(function () {
                                        return (0, makeRequestWithCookies_1.postWithCookies)("".concat(endpoint, "/chunked/uploadChunk"), headers, cookieJar, chunk);
                                    })
