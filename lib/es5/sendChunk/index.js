            ...
            switch (_b.label) {
                case 0:
                    ...
                    inst = axios_1.default.create({
                        headers: __assign({ "content-type": "application/octet-stream", "one-time-token": oneTimeToken, "x-file-name": fileName, "x-last": "".concat(index, "/").concat(chunksLength), "x-chunk-index": "".concat(index), "X-folder": file.folderId || "", "x-mime": file === null || file === void 0 ? void 0 : file.type, "X-Ai-Generated": false }, headers),
                        onUploadProgress: function (event) {
                            if (event.loaded === chunk.byteLength) {
                                ...
                                handlers.includes("onProgress") &&
                                    callback({
                                        type: "onProgress",
                                        params: { id: file.upload_id, progress: progress, timeLeft: timeLeft },
                                    });
                            }
                        },
                    });
