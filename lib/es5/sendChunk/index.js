        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    chunksLength = Math.ceil(file.size / gateway.upload_chunk_size);
                    currentTry = 1;
                    cookieJar = [];
                    headers = {
                    ...
                    uploadChunk = function (chunk) { return __awaiter(void 0, void 0, void 0, function () {
                        var response, prevProgress, progress, elapsedTime, size, remainingBytes, bytesPerMillisecond, remainingTime, timeLeft, error_1, isNetworkError, isOtherError;
                        var _a, _b;
