...
var swapChunk = function (file, endpoint, base64iv, clientsideKeySha3Hash, currentIndex, chunksLength, oneTimeToken, encryptedChunk, arrayBuffer, startTime, totalProgress, callback) { return __awaiter(void 0, void 0, void 0, function () {
    var url, inst;
    var _a;
            ...
            case 0:
                ...
                inst = axios_1.default.create({
                    headers: {
                        ...
                        "x-last": "".concat(currentIndex, "/").concat(chunksLength),
                    ...
                    onUploadProgress: function (event) {
                        if (event.loaded === encryptedChunk.byteLength) {
                            ...
                            var remainingBytes = arrayBuffer.byteLength - progress;
