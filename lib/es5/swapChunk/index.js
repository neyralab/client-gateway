...
var swapChunk = function (file, endpoint, base64iv, clientsideKeySha3Hash, currentIndex, chunksLength, oneTimeToken, encryptedChunk, arrayBuffer, startTime, dispatch, updateProgressCallback) { return __awaiter(void 0, void 0, void 0, function () {
    var url, inst;
    var _a;
                ...
                inst = axios_1.default.create({
                    ...
                    onUploadProgress: function (event) {
                        if (event.loaded === encryptedChunk.byteLength) {
                            var prevProgress = localStorage.getItem("progress") || 0;
