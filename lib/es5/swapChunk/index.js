...
exports.swapChunk = void 0;
var axios_1 = require("axios");
var swapChunk = function (_a) {
    var file = _a.file, gateway = _a.gateway, base64iv = _a.base64iv, clientsideKeySha3Hash = _a.clientsideKeySha3Hash, index = _a.index, oneTimeToken = _a.oneTimeToken, encryptedChunk = _a.encryptedChunk, fileSize = _a.fileSize, startTime = _a.startTime, totalProgress = _a.totalProgress, callback = _a.callback, handlers = _a.handlers;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    url = "".concat(gateway.url, "/chunked/swap/").concat(file.slug);
