...
var chunkBase64_1 = require("./chunkBase64");
    ...
    return __asyncGenerator(this, arguments, function chunkFile_1() {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 20:
                    if (!(file instanceof File_1.LocalFileReactNativeStream)) return [3 /*break*/, 23];
                    return [5 /*yield**/, __values(__asyncDelegator(__asyncValues((0, chunkBase64_1.chunkBase64)(file.chunks))))];
                ...
                case 24:
                    arrayBuffer = _f.sent();
                    return [5 /*yield**/, __values(__asyncDelegator(__asyncValues((0, chunkBuffer_1.chunkBuffer)({ arrayBuffer: arrayBuffer, uploadChunkSize: uploadChunkSize }))))];
