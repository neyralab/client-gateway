...
exports.chunkFileStream = exports.chunkFile = void 0;
var CHUNK_SIZE = 1024 * 1024;
var chunkFile = function (_a) {
...
var chunkFileStream = function (_a) {
    var stream = _a.stream;
    return __awaiter(void 0, void 0, void 0, function () {
        var Readable, smallerStreams, currentOffset;
        return __generator(this, function (_b) {
            Readable = require("stream").Readable;
            smallerStreams = [];
            currentOffset = 0;
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    stream.on("readable", function () { return __awaiter(void 0, void 0, void 0, function () {
                        var chunk, smallerReadable;
                        return __generator(this, function (_a) {
                            chunk = stream.read(CHUNK_SIZE);
                            if (chunk) {
                                currentOffset += chunk.length;
                                smallerReadable = new Readable();
...
exports.chunkFileStream = chunkFileStream;
