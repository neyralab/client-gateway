...
exports.encodeExistingFile = void 0;
...
md.update(fileKey);
var encodeExistingFile = function (_a) {
    var file = _a.file, oneTimeToken = _a.oneTimeToken, endpoint = _a.endpoint, downloadToken = _a.downloadToken, downloadEndpoint = _a.downloadEndpoint, callback = _a.callback, handlers = _a.handlers, key = _a.key;
        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 4:
                    ...
                    _b = true, _c = __asyncValues((0, chunkBuffer_1.chunkBuffer)({ arrayBuffer: arrayBuffer }));
                    _k.label = 5;
                ...
                case 6:
                    ...
                    _b = false;
                    chunk = _g;
                    return [4 /*yield*/, (0, index_1.encryptChunk)({ chunk: chunk, iv: iv, key: key })];
                case 7:
...
exports.encodeExistingFile = encodeExistingFile;
