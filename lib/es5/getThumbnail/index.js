...
exports.getThumbnailVideo = exports.getThumbnailImage = void 0;
var axios_1 = require("axios");
var fs = require("fs");
var MAX_WIDTH = 240;
var MAX_HEIGHT = 240;
var getThumbnailImage = function (_a) {
    var path = _a.path, file = _a.file, quality = _a.quality, getOneTimeToken = _a.getOneTimeToken, slug = _a.slug, sharp = _a.sharp;
...
var getThumbnailVideo = function (_a) {
    var path = _a.path, file = _a.file, quality = _a.quality, getOneTimeToken = _a.getOneTimeToken, slug = _a.slug, ffmpegCommand = _a.ffmpegCommand, sharp = _a.sharp;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, (0, exports.getThumbnailImage)({
                                                file: file,
                                                path: thumbnailPath,
                                                quality: quality,
