...
var uploadFile = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var startTime, controller, clientsideKeySha3Hash, iv, totalProgress, currentIndex, lastChunkIndex, leftChunks, restMaxPromisesLength, promises, fileKey, md, _b, _c, _d, chunk, allowedPromisesLength, finalChunk, promise, results, _i, results_1, result, e_1_1;
        var _e, e_1, _f, _g;
        var _h, _j;
        return __generator(this, function (_k) {
            switch (_k.label) {
                case 0:
                    ...
                    currentIndex = 1;
                    lastChunkIndex = Math.ceil(file.size / gateway.upload_chunk_size);
