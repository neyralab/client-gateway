...
var uploadFile = function (_a) {
    var file = _a.file, oneTimeToken = _a.oneTimeToken, endpoint = _a.endpoint, callback = _a.callback, handlers = _a.handlers, needStream = _a.needStream, stream = _a.stream;
    return __awaiter(void 0, void 0, void 0, function () {
        var startTime, totalProgress, chunks, result, arrayBuffer, arrayBuffer, _loop_1, _i, chunks_1, chunk, state_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    startTime = Date.now();
                    totalProgress = { number: 0 };
                    if (!needStream) return [3 /*break*/, 2];
                    return [4 /*yield*/, (0, streamToBuffer_1.streamToBuffer)({ stream: stream })];
                case 1:
                    arrayBuffer = _b.sent();
                    chunks = (0, chunkFile_1.chunkFile)({ arrayBuffer: arrayBuffer });
                    return [3 /*break*/, 4];
