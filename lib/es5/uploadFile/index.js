...
var uploadFile = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var startTime, totalProgress, chunks, result, stream, arrayBuffer, arrayBuffer, _loop_1, _i, chunks_1, chunk, state_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    startTime = Date.now();
                    totalProgress = { number: 0 };
                    if (!(file === null || file === void 0 ? void 0 : file.isStream)) return [3 /*break*/, 3];
