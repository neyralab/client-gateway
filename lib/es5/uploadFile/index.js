...
var uploadFile = function (_a) {
    var file = _a.file, oneTimeToken = _a.oneTimeToken, endpoint = _a.endpoint, callback = _a.callback, handlers = _a.handlers, key = _a.key, progress = _a.progress, totalSize = _a.totalSize, startedAt = _a.startedAt;
        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 1:
                    ...
                    _b = true, _c = __asyncValues((0, chunkFile_1.chunkFile)({ file: file }));
                    _k.label = 2;
                ...
                case 4:
                    finalChunk = _k.sent();
                    _k.label = 5;
                case 5: return [4 /*yield*/, (0, sendChunk_1.sendChunk)({
                        chunk: finalChunk,
                        index: currentIndex,
                        file: file,
                        startTime: startTime,
