...
export declare class WebCrypto {
    ...
    downloadFile(currentFile: File | any, oneTimeToken: string, activationKey: string, signal: AbortSignal, endpoint: string, dispatch: DispatchType, successfullyDecryptedCallback: (dispatch: DispatchType) => void): Promise<any>;
