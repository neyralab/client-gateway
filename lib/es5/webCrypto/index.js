...
var crypto = !window || !((_a = window.crypto) === null || _a === void 0 ? void 0 : _a.subtle) ? new webcrypto_1.Crypto() : window.crypto;
crypto.subtle
                            ...
                            return __generator(this, function (_g) {
                                switch (_g.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, (0, index_1.encryptChunk)(chunk, this_1.iv)];
                                    case 1:
                        ...
                        _loop_2 = function (chunk) {
                            ...
                            return __generator(this, function (_e) {
                                switch (_e.label) {
                                    case 0:
                                        currentIndex = chunks.findIndex(function (el) { return el === chunk; });
                                        return [4 /*yield*/, (0, index_1.encryptChunk)(chunk, this_2.iv)];
                                    case 1:
