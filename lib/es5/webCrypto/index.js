                            ...
                            return __generator(this, function (_g) {
                                switch (_g.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, (0, index_1.sendChunk)(encryptedChunk, currentIndex, chunks.length - 1, file, startTime, oneTimeToken, endpoint, this_1.iv, this_1.clientsideKeySha3Hash, dispatch, totalProgress, updateProgressCallback)];
                                    case 2:
                                        result = _g.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, (0, index_1.downloadChunk)(index, clientsideKeySha3Hash || sha3_hash, slug, oneTimeToken, signal, endpoint)];
                    case 4:
                            ...
                            return __generator(this, function (_e) {
                                switch (_e.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, (0, index_1.swapChunk)(file, endpoint, base64iv, this_2.clientsideKeySha3Hash, currentIndex, chunks.length - 1, oneTimeToken, encryptedChunk, arrayBuffer, startTime, dispatch, totalProgress, updateProgressCallback)];
                                    case 2:
                                        data = _e.sent();
                                        return [2 /*return*/];
                                }
