            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, index_1.downloadFile)(file, ottDownloadToken, signal, ottEndpoint, false, null, null, null)];
                    case 2:
                        fileBlob = _e.sent();
                            ...
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, (0, index_1.swapChunk)(file, endpoint, base64iv, this_2.clientsideKeySha3Hash, currentIndex, chunks.length - 1, oneTimeToken, encryptedChunk, arrayBuffer, startTime, totalProgress, callback)];
                                    case 2:
                                        data = _f.sent();
                                        return [2 /*return*/];
                                }
