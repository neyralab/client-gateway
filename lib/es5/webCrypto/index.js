...
var WebCrypto = /** @class */ (function () {
    ...
    WebCrypto.prototype.encodeFile = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var startTime, currentIndex, result, totalProgress, stream, chunksLength, lastChunkSize, _g, _h, _j, chunk, encryptedChunk, e_1_1, arrayBuffer, chunks, totalProgress_1, _loop_1, this_1, _i, chunks_1, chunk, state_1;
            return __generator(this, function (_k) {
                switch (_k.label) {
                    case 0:
                        ...
                        if (!((file === null || file === void 0 ? void 0 : file.isStream) && !(0, hasWindow_1.hasWindow)())) return [3 /*break*/, 15];
                        stream = file.stream();
                    ...
                    case 1:
                        ...
                        _g = true, _h = __asyncValues((0, chunkStream_1.chunkStream)({
                            stream: stream,
                    ...
                    case 3:
                        ...
                        _g = false;
                        chunk = _d;
                        return [4 /*yield*/, (0, index_1.encryptChunk)({
                                chunk: chunk,
                                iv: this.iv,
                                key: key,
                            })];
                    ...
                    case 15: return [4 /*yield*/, file.arrayBuffer()];
                    case 16:
                        arrayBuffer = _k.sent();
                        chunks = (0, chunkBuffer_1.chunkBuffer)({ arrayBuffer: arrayBuffer });
                        totalProgress_1 = { number: 0 };
                        _loop_1 = function (chunk) {
                            var currentIndex_1, encryptedChunk;
                            return __generator(this, function (_l) {
                                switch (_l.label) {
                                    case 0:
                                        currentIndex_1 = chunks.findIndex(function (el) { return el === chunk; });
                                        return [4 /*yield*/, (0, index_1.encryptChunk)({ chunk: chunk, iv: this_1.iv, key: key })];
                                    case 1:
                                        encryptedChunk = _l.sent();
                                        return [4 /*yield*/, (0, index_1.sendChunk)({
                                                chunk: encryptedChunk,
                                                index: currentIndex_1,
                        ...
                        _k.label = 17;
                    case 17:
                        if (!(_i < chunks_1.length)) return [3 /*break*/, 20];
                        chunk = chunks_1[_i];
    ...
    WebCrypto.prototype.encodeExistingFile = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var controller, signal, _b, downloadToken, downloadEndpoint, fileBlob, arrayBuffer, chunks, _c, oneTimeToken, endpoint, startTime, base64iv, totalProgress, data, _loop_2, this_2, _i, chunks_2, chunk, e_2, responseFromIpfs, isCancelModalOpen;
