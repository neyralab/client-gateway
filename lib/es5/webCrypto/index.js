...
var WebCrypto = /** @class */ (function () {
    ...
    WebCrypto.prototype.encodeFile = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var chunkSize, totalChunks, startTime, reader, currentIndex, result, totalProgress, _b, done, value, encryptedChunk, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        chunkSize = 1024 * 1024;
                        totalChunks = Math.ceil(Math.floor(file.size / chunkSize) / 2);
                        startTime = Date.now();
    ...
    WebCrypto.prototype.encodeExistingFile = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var controller, signal, _b, downloadToken, downloadEndpoint, fileBlob, arrayBuffer, chunks, fileSignal, _c, oneTimeToken, endpoint, startTime, base64iv, totalProgress, data, _loop_1, this_1, _i, chunks_1, chunk, e_1, responseFromIpfs, isCancelModalOpen;
