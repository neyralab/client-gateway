...
exports.cancelingEncryptAndUpload = exports.WebCrypto = void 0;
...
var WebCrypto = /** @class */ (function () {
    ...
    WebCrypto.prototype.encodeFile = function (_a) {
        var _b, e_1, _c, _d;
        var _e, _f;
        var file = _a.file, oneTimeToken = _a.oneTimeToken, endpoint = _a.endpoint, callback = _a.callback, handlers = _a.handlers, key = _a.key, crypto = _a.crypto;
        return __awaiter(this, void 0, void 0, function () {
            var controller, startTime, totalProgress, currentIndex, result, _g, _h, _j, chunk, encryptedChunk, e_1_1;
            return __generator(this, function (_k) {
                switch (_k.label) {
                    ...
                    case 1:
                        ...
                        _g = true, _h = __asyncValues((0, chunkFile_1.chunkFile)({ file: file }));
                        _k.label = 2;
            ...
            return __generator(this, function (_m) {
                switch (_m.label) {
                    ...
                    case 6:
                        ...
                        _j = true, _k = __asyncValues((0, chunkBuffer_1.chunkBuffer)({ arrayBuffer: arrayBuffer }));
                        _m.label = 7;
                    ...
                    case 8:
                        ...
                        _j = false;
                        chunk = _d;
                        return [4 /*yield*/, (0, index_1.encryptChunk)({ chunk: chunk, iv: this.iv, key: key })];
                    case 9:
...
var cancelingEncryptAndUpload = function (uploadId) {
...
exports.cancelingEncryptAndUpload = cancelingEncryptAndUpload;
