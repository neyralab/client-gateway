...
var arrayBufferToStream_1 = require("../utils/arrayBufferToStream");
var getFibonacciNumber_1 = require("../utils/getFibonacciNumber");
var hasWindow_1 = require("../utils/hasWindow");
var downloadChunk = function (index, sha3_hash, slug, oneTimeToken, signal, endpoint, encrypted) { return __awaiter(void 0, void 0, void 0, function () {
    var currentTry, download, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
                ...
                download = function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            ...
                            case 2:
                                _c.trys.push([2, 4, , 5]);
                                return [4 /*yield*/, fetch(endpoint + "/chunked/downloadChunk/".concat(slug), {
                                        method: "GET",
                                        headers: {
                            ...
                            case 4:
                                error_1 = _c.sent();
                                if (((_a = error_1 === null || error_1 === void 0 ? void 0 : error_1.message) === null || _a === void 0 ? void 0 : _a.includes("Network Error")) ||
            ...
            case 1:
                ...
                if (!(0, hasWindow_1.hasWindow)() && !encrypted) {
                    return [2 /*return*/, (0, arrayBufferToStream_1.arrayBufferToStream)(response.data)];
                }
                else {
