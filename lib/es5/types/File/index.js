...
exports.LocalFileBuffer = exports.LocalFileStream = exports.LocalFile = void 0;
var fs = require("fs");
var LocalFile = /** @class */ (function () {
    function LocalFile(size, filename, mimeType, fileFolderId, source) {
        this.name = filename;
        this.type = mimeType;
...
var LocalFileStream = /** @class */ (function (_super) {
    ...
    function LocalFileStream(size, filename, mimeType, fileFolderId, source) {
        var _this = _super.call(this, size, filename, mimeType, fileFolderId, source) || this;
        _this.isStream = true;
...
var LocalFileBuffer = /** @class */ (function (_super) {
    ...
    function LocalFileBuffer(size, filename, mimeType, fileFolderId, arrayBuffer, source) {
        var _this = _super.call(this, size, filename, mimeType, fileFolderId, source) || this;
