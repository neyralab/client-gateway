...
export function chunkFile(_a) {
    var file = _a.file, uploadChunkSize = _a.uploadChunkSize;
    return __asyncGenerator(this, arguments, function chunkFile_1() {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    if (!(file instanceof LocalFileStream)) return [3 /*break*/, 20];
                    stream = file.stream();
                    lastChunkSize = file.size > uploadChunkSize
                ...
                case 4:
                    ...
                    spaceLeft = uploadChunkSize - offset;
                    ...
                    offset += chunkToCopy;
                    if (!(offset === uploadChunkSize)) return [3 /*break*/, 7];
                ...
                case 20:
                    if (!(file instanceof LocalFileReactNativeStream)) return [3 /*break*/, 23];
                    return [5 /*yield**/, __values(__asyncDelegator(__asyncValues(chunkBase64(file.chunks))))];
                case 21: return [4 /*yield*/, __await.apply(void 0, [_f.sent()])];
                case 22:
                    _f.sent();
                    return [3 /*break*/, 27];
                case 23: return [4 /*yield*/, __await(file.arrayBuffer())];
                case 24:
                    arrayBuffer = _f.sent();
                    return [5 /*yield**/, __values(__asyncDelegator(__asyncValues(chunkBuffer({ arrayBuffer: arrayBuffer, uploadChunkSize: uploadChunkSize }))))];
                case 25: return [4 /*yield*/, __await.apply(void 0, [_f.sent()])];
                case 26:
                    _f.sent();
                    _f.label = 27;
