...
import { LocalFileStream } from "../types/File";
export function chunkFile(_a) {
    var file = _a.file;
    return __asyncGenerator(this, arguments, function chunkFile_1() {
        var stream, lastChunkSize, buffer, offset, _b, stream_1, stream_1_1, chunk, position, spaceLeft, chunkToCopy, e_1_1, arrayBuffer, start, end, chunk;
        var _c, e_1, _d, _e;
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 4:
                    ...
                    offset += chunkToCopy;
                    if (!(offset === CHUNK_SIZE)) return [3 /*break*/, 7];
                ...
                case 21:
                    ...
                    _f.label = 22;
                case 22:
                    if (!(start < arrayBuffer.byteLength)) return [3 /*break*/, 25];
                    end = Math.min(arrayBuffer.byteLength, start + CHUNK_SIZE);
                    chunk = arrayBuffer.slice(start, end);
