...
export function chunkStream(_a) {
    var stream = _a.stream, lastChunkSize = _a.lastChunkSize;
    return __asyncGenerator(this, arguments, function chunkStream_1() {
        var buffer, offset, _b, stream_1, stream_1_1, chunk, position, spaceLeft, chunkToCopy, e_1_1;
        var _c, e_1, _d, _e;
