...
export var swapChunk = function (file, endpoint, base64iv, clientsideKeySha3Hash, currentIndex, chunksLength, oneTimeToken, encryptedChunk, arrayBuffer, startTime, dispatch, updateProgressCallback, getProgressFromLSCallback, setProgressToLSCallback) { return __awaiter(void 0, void 0, void 0, function () {
    var url, inst;
    var _a;
