        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                case 0:
                    ...
                    if (!((file === null || file === void 0 ? void 0 : file.isStream) && !hasWindow())) return [3 /*break*/, 14];
                    stream = file.stream();
                ...
                case 1:
                    ...
                    _b = true, _c = __asyncValues(chunkStream({ stream: stream, lastChunkSize: lastChunkSize }));
                    _k.label = 2;
