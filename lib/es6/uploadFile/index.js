...
export var uploadFile = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var startTime, controller, clientsideKeySha3Hash, iv, totalProgress, currentIndex, promises, fileKey, md, _b, _c, _d, chunk, finalChunk, promise, e_1_1, results, _i, results_1, result;
        var _e, e_1, _f, _g;
        var _h, _j;
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 5:
                    ...
                    if (!(promises.length === 4)) return [3 /*break*/, 7];
                ...
                case 16: return [4 /*yield*/, Promise.all(promises)];
                case 17:
                    results = _k.sent();
