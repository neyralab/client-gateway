...
export const getThumbnailImage = ({ path, file, quality, oneTimeToken, endpoint, slug, sharp, }) => __awaiter(void 0, void 0, void 0, function* () {
...
export const getThumbnailVideo = ({ path, file, quality, oneTimeToken, endpoint, slug, ffmpegCommand, sharp, }) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
