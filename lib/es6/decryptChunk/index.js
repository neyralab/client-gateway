...
export var decryptChunk = function (chunk, iv, activationKey) { return __awaiter(void 0, void 0, void 0, function () {
    var decodeKey, key, ivBufferSource, normalizedIv, currentTry, decrypt;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                decodeKey = convertBase64ToArrayBuffer(activationKey);
                return [4 /*yield*/, crypto.subtle.importKey("raw", decodeKey, {
                        name: "AES-GCM",
                        length: 256,
                    }, true, ["encrypt", "decrypt"])];
            case 1:
                key = _a.sent();
                ivBufferSource = convertBase64ToArrayBuffer(iv);
