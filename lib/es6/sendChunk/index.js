        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    xHash = isMobile() ? 'null' : createSHA256Hash(chunk);
                    fileName = convertTextToBase64(file.name);
                    fileSize = file instanceof LocalFileReactNativeStream ? file.convertedSize || file.size : file.size;
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 2:
                                    _c.trys.push([2, 6, , 7]);
                                    response = void 0;
                                    if (!(!isBrowser() && !isMobile())) return [3 /*break*/, 3];
                                    response = axios
                                        ...
                                        .then(function () {
                                        return postWithCookies("".concat(gateway.url, "/chunked/uploadChunk"), headers, cookieJar, controller ? controller.signal : undefined, chunk);
                                    })
                                        .catch(function (error) {
                                        console.log('Error:', error);
                                    });
                                    return [3 /*break*/, 5];
                                case 3: return [4 /*yield*/, axios.post("".concat(gateway.url, "/chunked/uploadChunk"), chunk, {
                                        headers: headers,
                                ...
                                case 6:
                                    ...
                                    isOtherError = ERRORS.includes((_b = error_1 === null || error_1 === void 0 ? void 0 : error_1.response) === null || _b === void 0 ? void 0 : _b.status);
