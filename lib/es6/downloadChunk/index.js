...
export var downloadChunk = function (index, sha3_hash, slug, oneTimeToken, signal, endpoint, encrypted) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!hasWindow() && !encrypted) {
                    return [2 /*return*/, arrayBufferToStream(response.data)];
                }
                else {
