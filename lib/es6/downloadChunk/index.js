...
export var downloadChunk = function (_a) {
    var index = _a.index, sha3_hash = _a.sha3_hash, slug = _a.slug, oneTimeToken = _a.oneTimeToken, signal = _a.signal, endpoint = _a.endpoint;
    return __awaiter(void 0, void 0, void 0, function () {
        var currentTry, instance, download, response;
                    ...
                    download = function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 2:
                                    _c.trys.push([2, 4, , 5]);
                                    return [4 /*yield*/, instance.get(endpoint + "/chunked/downloadChunk/".concat(slug))];
                                case 3:
                                    response_1 = _c.sent();
                                    if (currentTry > 1) {
                                        currentTry = 1;
