...
export var downloadFile = function (_a) {
    var file = _a.file, oneTimeToken = _a.oneTimeToken, signal = _a.signal, endpoint = _a.endpoint, isEncrypted = _a.isEncrypted, key = _a.key, callback = _a.callback, handlers = _a.handlers;
    return __awaiter(void 0, void 0, void 0, function () {
        var chunks, fileStream, entry_clientside_key, slug, sha3, chunkCountResponse, res, count, Readable, index, chunk, downloadedChunk, file_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    if (!!isEncrypted) return [3 /*break*/, 5];
                    chunk = downloadedChunk;
                    return [3 /*break*/, 7];
                case 5: return [4 /*yield*/, decryptChunk({
                        chunk: downloadedChunk,
