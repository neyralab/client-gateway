...
export var downloadFile = function (_a) {
    var file = _a.file, oneTimeToken = _a.oneTimeToken, endpoint = _a.endpoint, isEncrypted = _a.isEncrypted, key = _a.key, callback = _a.callback, handlers = _a.handlers, signal = _a.signal, carReader = _a.carReader, uploadChunkSize = _a.uploadChunkSize;
    return __awaiter(void 0, void 0, void 0, function () {
        var startTime, chunks, entry_clientside_key, slug, sha3, totalProgress, fileStream, fileBlob, chunkCountResponse, count, Readable, index, chunk, downloadedChunk, bufferKey, file_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    fileStream = null;
                    if (!file.is_on_storage_provider) return [3 /*break*/, 2];
                ...
                case 2: return [4 /*yield*/, countChunks({
                        endpoint: endpoint,
