...
export var downloadFile = function (currentFile, oneTimeToken, signal, endpoint, encrypted, activationKey, dispatch, successfullyDecryptedCallback) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                chunk = void 0;
                return [4 /*yield*/, downloadChunk(index, sha3, slug, oneTimeToken, signal, endpoint)];
            case 4:
                downloadedChunk = _a.sent();
                if (!!encrypted) return [3 /*break*/, 5];
                chunk = downloadedChunk;
                return [3 /*break*/, 7];
            case 5: return [4 /*yield*/, decryptChunk(downloadedChunk, entry_clientside_key === null || entry_clientside_key === void 0 ? void 0 : entry_clientside_key.iv, activationKey)];
            case 6:
                chunk = _a.sent();
