...
export var downloadFile = function (_a) {
    var file = _a.file, oneTimeToken = _a.oneTimeToken, endpoint = _a.endpoint, isEncrypted = _a.isEncrypted, key = _a.key, callback = _a.callback, handlers = _a.handlers, signal = _a.signal, carReader = _a.carReader, uploadChunkSize = _a.uploadChunkSize, cidData = _a.cidData, writeStreamMobile = _a.writeStreamMobile;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    size = Number((file.size / ONE_MB).toFixed(1));
                    if (!(size < ALL_FILE_DOWNLOAD_MAX_SIZE)) return [3 /*break*/, 2];
                    return [4 /*yield*/, downloadFileFromSP({
                            carReader: carReader,
                ...
                case 2:
                    if (!(size >= ALL_FILE_DOWNLOAD_MAX_SIZE)) return [3 /*break*/, 8];
                    cids = cidData.cids;
                    chunks_1 = [];
                    i = 0;
                    _b.label = 3;
                ...
                case 6:
                    i++;
                    return [3 /*break*/, 3];
                case 7: return [2 /*return*/, joinChunks(chunks_1)];
                case 8: return [3 /*break*/, 21];
                case 9: return [4 /*yield*/, countChunks({
                        endpoint: endpoint,
                ...
                case 10:
                    ...
                    _b.label = 11;
                case 11:
                    if (!(index < count)) return [3 /*break*/, 20];
                    chunk = void 0;
                ...
                case 14:
                    ...
                    _b.label = 15;
                case 15:
                    if (!fileStream) return [3 /*break*/, 16];
                    fileStream.push(new Uint8Array(chunk));
                    return [3 /*break*/, 19];
                case 16:
                    if (!isMobile()) return [3 /*break*/, 18];
                    return [4 /*yield*/, writeStreamMobile(chunk)];
                case 17:
                    _b.sent();
                    return [3 /*break*/, 19];
                case 18:
