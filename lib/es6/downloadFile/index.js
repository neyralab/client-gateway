...
export var downloadFile = function (_a) {
    var file = _a.file, oneTimeToken = _a.oneTimeToken, endpoint = _a.endpoint, isEncrypted = _a.isEncrypted, key = _a.key, callback = _a.callback, handlers = _a.handlers, signal = _a.signal, cidUrl = _a.cidUrl;
    return __awaiter(void 0, void 0, void 0, function () {
        var isFileFromSP, gateway, startTime, chunks, totalProgress, fileStream, entry_clientside_key, slug, sha3, test_url, test_data, chunkCountResponse, count, Readable, index, chunk, downloadedChunk, bufferKey, file_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    console.log("file", file);
                    console.log("gateway", endpoint);
                    isFileFromSP = file.storage_provider;
                    gateway = isFileFromSP ? file.storage_provider.url : endpoint;
                    startTime = Date.now();
                    chunks = [];
                    ...
                    if (isFileFromSP) {
                        test_url = "".concat(cidUrl, "/").concat(file.cid, "/1");
                        test_data = axios.get(test_url);
