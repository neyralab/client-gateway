...
export var getUserRSAKeys = function (provider, signMessageCallback) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, signMessageCallback(false, provider, false, msg)];
                case 1:
                    rnd = (_a.sent())
                        .signature;
                    prng = window.forge.random.createInstance();
                    ...
                    return [2 /*return*/, window.forge.pki.rsa.generateKeyPair(2048, { prng: prng })];
            }
        });
    });
};
