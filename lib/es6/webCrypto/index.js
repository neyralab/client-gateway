...
var WebCrypto = /** @class */ (function () {
    ...
    WebCrypto.prototype.encodeFile = function (_a) {
        var _b, _c, _d, _e;
        var file = _a.file, oneTimeToken = _a.oneTimeToken, endpoint = _a.endpoint, getKeysByWorkspace = _a.getKeysByWorkspace, saveEncryptedFileKeys = _a.saveEncryptedFileKeys, getOneTimeToken = _a.getOneTimeToken, callback = _a.callback, handlers = _a.handlers, keypair = _a.keypair;
        return __awaiter(this, void 0, void 0, function () {
            var startTime, arrayBuffer, chunks, base64Image, result, keys, totalProgress, key, _loop_1, this_1, _i, chunks_1, chunk, state_1, bufferKey, base64Key, encryptedKey, encryptedHexKey, encryptedKeys, _f, thumbToken, thumbEndpoint, instance, e_1;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        ...
                        switch (true) {
                            case file.type.startsWith("image"):
                                getThumbnailImage(file).then(function (result) {
                                    base64Image = result;
                                });
                                break;
                            case file.type.startsWith("video"):
                                getThumbnailVideo(file).then(function (result) {
                                    base64Image = result;
                                });
                                break;
                        }
                    ...
                    case 2:
                        keys = (_g.sent()).data.keys;
                        totalProgress = { number: 0 };
                        return [4 /*yield*/, crypto.subtle.generateKey({ name: "AES-GCM", length: 256 }, true, ["encrypt", "decrypt"])];
                    case 3:
                        key = _g.sent();
                    ...
                    case 6:
                        _i++;
                        return [3 /*break*/, 4];
                    case 7: return [4 /*yield*/, crypto.subtle.exportKey("raw", key)];
                    case 8:
                        bufferKey = _g.sent();
                        base64Key = convertArrayBufferToBase64(bufferKey);
                        return [4 /*yield*/, keypair.publicKey.encrypt(base64Key)];
                    case 9:
                        encryptedKey = _g.sent();
                        encryptedHexKey = forge.util.bytesToHex(encryptedKey);
                        encryptedKeys = keys.map(function (el) {
                            return { publicKey: el, encryptedFileKey: encryptedHexKey };
                        });
                        saveEncryptedFileKeys({
                            slug: (_c = (_b = result === null || result === void 0 ? void 0 : result.data) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.slug,
                            encryptedKeys: encryptedKeys,
                        });
                        totalProgress.number = 0;
                        return [4 /*yield*/, getOneTimeToken({ filename: file.name, filesize: file.size })];
                    case 10:
                        _f = (_g.sent()).data, thumbToken = _f.user_token.token, thumbEndpoint = _f.endpoint;
                    ...
                    case 11:
                        ...
                        if (!base64Image) return [3 /*break*/, 13];
                        return [4 /*yield*/, instance.post("".concat(thumbEndpoint, "/chunked/thumb/").concat((_e = (_d = result === null || result === void 0 ? void 0 : result.data) === null || _d === void 0 ? void 0 : _d.data) === null || _e === void 0 ? void 0 : _e.slug), base64Image)];
                    case 12:
                        _g.sent();
                        _g.label = 13;
    ...
    WebCrypto.prototype.encodeExistingFile = function (_a) {
        var _b;
        var file = _a.file, getImagePreviewEffect = _a.getImagePreviewEffect, getKeysByWorkspace = _a.getKeysByWorkspace, saveEncryptedFileKeys = _a.saveEncryptedFileKeys, getOneTimeToken = _a.getOneTimeToken, getDownloadOTT = _a.getDownloadOTT, callback = _a.callback, handlers = _a.handlers, keypair = _a.keypair;
        return __awaiter(this, void 0, void 0, function () {
            var controller, signal, _c, downloadToken, downloadEndpoint, fileBlob, arrayBuffer, chunks, fileSignal, thumbnail, hasThumbnail, _d, oneTimeToken, endpoint, keys, startTime, base64iv, key, totalProgress, data, _loop_2, this_2, _i, chunks_2, chunk, e_2, responseFromIpfs, bufferKey, base64Key, encryptedKey, encryptedHexKey_1, encryptedKeys, isCancelModalOpen, _e, thumbToken_1, thumbEndpoint_1, fileName_1, e_3;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                        _c = (_f.sent()).data, downloadToken = _c.user_tokens.token, downloadEndpoint = _c.endpoint;
                    ...
                    case 6:
                        _d = (_f.sent()).data, oneTimeToken = _d.user_token.token, endpoint = _d.endpoint;
                        return [4 /*yield*/, getKeysByWorkspace()];
                    case 7:
                    ...
                    case 9:
                        ...
                        _f.label = 10;
                    case 10:
                        if (!(_i < chunks_2.length)) return [3 /*break*/, 13];
                        chunk = chunks_2[_i];
                    ...
                    case 15:
                        ...
                        if (!responseFromIpfs) return [3 /*break*/, 21];
                    ...
                    case 16:
                        ...
                        return [4 /*yield*/, keypair.publicKey.encrypt(base64Key)];
                    case 17:
                        encryptedKey = _f.sent();
                        encryptedHexKey_1 = forge.util.bytesToHex(encryptedKey);
                        encryptedKeys = keys.map(function (el) {
                            return { publicKey: el, encryptedFileKey: encryptedHexKey_1 };
                        });
                        saveEncryptedFileKeys({
                            slug: (_b = responseFromIpfs === null || responseFromIpfs === void 0 ? void 0 : responseFromIpfs.data) === null || _b === void 0 ? void 0 : _b.slug,
                            encryptedKeys: encryptedKeys,
                        });
                        ...
                        if (!hasThumbnail) return [3 /*break*/, 21];
                        _f.label = 18;
                    case 18:
                    ...
                    case 19:
                        _e = (_f.sent()).data, thumbToken_1 = _e.user_token.token, thumbEndpoint_1 = _e.endpoint;
                        fileName_1 = convertTextToBase64(file.name);
