...
var WebCrypto = /** @class */ (function () {
    ...
    WebCrypto.prototype.encodeExistingFile = function (_a) {
        var _b;
        var file = _a.file, getImagePreviewEffect = _a.getImagePreviewEffect, getKeysByWorkspace = _a.getKeysByWorkspace, saveEncryptedFileKeys = _a.saveEncryptedFileKeys, getOneTimeToken = _a.getOneTimeToken, getDownloadOTT = _a.getDownloadOTT, callback = _a.callback, handlers = _a.handlers;
        return __awaiter(this, void 0, void 0, function () {
            var controller, signal, _c, downloadToken, downloadEndpoint, fileBlob, arrayBuffer, chunks, fileSignal, thumbnail, hasThumbnail, _d, oneTimeToken, endpoint, keys, startTime, base64iv, key, totalProgress, data, _loop_2, this_2, _i, chunks_2, chunk, e_2, responseFromIpfs, buffer, text_1, encryptedKeys, isCancelModalOpen, _e, thumbToken_1, thumbEndpoint_1, fileName_1, e_3;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 15:
                        ...
                        if (!responseFromIpfs) return [3 /*break*/, 20];
                        return [4 /*yield*/, crypto.subtle.exportKey("raw", key)];
                    case 16:
                        buffer = _f.sent();
                        text_1 = convertArrayBufferToBase64(buffer);
                        encryptedKeys = keys.map(function (el) {
                        ...
                        if (!hasThumbnail) return [3 /*break*/, 20];
                        _f.label = 17;
                    case 17:
