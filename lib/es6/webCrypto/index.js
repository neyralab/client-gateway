...
var crypto = !window || !((_a = window.crypto) === null || _a === void 0 ? void 0 : _a.subtle) ? new Crypto() : window.crypto;
crypto.subtle
...
var WebCrypto = /** @class */ (function () {
    ...
    WebCrypto.prototype.encodeFile = function (file, oneTimeToken, dispatch, startTime, endpoint, getKeysByWorkspace, updateProgressCallback, getProgressFromLSCallback, setProgressToLSCallback, saveEncryptedFileKeys, getOneTimeToken) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var arrayBuffer, chunks, base64Image, result, keys, _loop_1, this_1, _i, chunks_1, chunk, state_1, buffer, keyBase64, encryptedKeys, _e, thumbToken, thumbEndpoint, instance, e_1;
            return __generator(this, function (_f) {
                switch (_f.label) {
                            ...
                            return __generator(this, function (_g) {
                                switch (_g.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, encryptChunk(chunk, this_1.iv)];
                                    case 1:
                                        encryptedChunk = _g.sent();
                                        return [4 /*yield*/, sendChunk(encryptedChunk, currentIndex, chunks.length - 1, file, startTime, oneTimeToken, endpoint, this_1.iv, this_1.clientsideKeySha3Hash, dispatch, updateProgressCallback, getProgressFromLSCallback, setProgressToLSCallback)];
                                    case 2:
                                        result = _g.sent();
                    ...
                    case 5:
                        _i++;
                        return [3 /*break*/, 3];
                    case 6: return [4 /*yield*/, crypto.subtle.exportKey("raw", window.key)];
                    case 7:
                        buffer = _f.sent();
    ...
    WebCrypto.prototype.encodeExistingFile = function (file, dispatch, getFileContent, firstEncodeExistingCallback, secondEncodeExistingCallback, thirdEncodeExistingCallback, getImagePreviewEffect, getKeysByWorkspace, updateProgressCallback, getProgressFromLSCallback, setProgressToLSCallback, saveEncryptedFileKeys, getOneTimeToken) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var fileBlob, arrayBuffer, chunks, fileSignal, thumbnail, hasThumbnail, _b, oneTimeToken, endpoint, keys, startTime, base64iv, data, _loop_2, this_2, _i, chunks_2, chunk, e_2, responseFromIpfs, buffer, text_1, encryptedKeys, isCancelModalOpen, _c, thumbToken_1, thumbEndpoint_1, fileName_1, e_3;
            return __generator(this, function (_d) {
                switch (_d.label) {
                        ...
                        _loop_2 = function (chunk) {
                            ...
                            return __generator(this, function (_e) {
                                switch (_e.label) {
                                    case 0:
                                        currentIndex = chunks.findIndex(function (el) { return el === chunk; });
                                        return [4 /*yield*/, encryptChunk(chunk, this_2.iv)];
                                    case 1:
                                        encryptedChunk = _e.sent();
                                        return [4 /*yield*/, swapChunk(file, endpoint, base64iv, this_2.clientsideKeySha3Hash, currentIndex, chunks.length - 1, oneTimeToken, encryptedChunk, arrayBuffer, startTime, dispatch, updateProgressCallback, getProgressFromLSCallback, setProgressToLSCallback)];
                                    case 2:
                                        data = _e.sent();
                                        return [2 /*return*/];
                                }
                    ...
                    case 13:
                        ...
                        return [4 /*yield*/, crypto.subtle.exportKey("raw", window.key)];
                    case 14:
                        buffer = _d.sent();
