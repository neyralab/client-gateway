...
import { chunkFile, countChunks, decryptChunk, downloadChunk, encryptChunk, sendChunk, swapChunk, } from "../index";
...
var WebCrypto = /** @class */ (function () {
    ...
    WebCrypto.prototype.encodeFile = function (file, oneTimeToken, dispatch, endpoint, getKeysByWorkspace, updateProgressCallback, saveEncryptedFileKeys, getOneTimeToken) {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function () {
            var startTime, arrayBuffer, chunks, base64Image, result, keys, totalProgress, key, _loop_1, this_1, _i, chunks_1, chunk, state_1, buffer, keyBase64, encryptedKeys, _e, thumbToken, thumbEndpoint, instance, e_1;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2:
                        ...
                        key = hasWindow() ? window.key : global.key;
                            ...
                            return __generator(this, function (_g) {
                                switch (_g.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, encryptChunk(chunk, this_1.iv, key)];
                                    case 1:
                                        encryptedChunk = _g.sent();
                                        return [4 /*yield*/, sendChunk(encryptedChunk, currentIndex, chunks.length - 1, file, startTime, oneTimeToken, endpoint, this_1.iv, this_1.clientsideKeySha3Hash, dispatch, totalProgress, updateProgressCallback)];
                                    case 2:
                                        result = _g.sent();
                    ...
                    case 5:
                        _i++;
                        return [3 /*break*/, 3];
                    case 6: return [4 /*yield*/, crypto.subtle.exportKey("raw", hasWindow() ? window.key : global.key)];
                    case 7:
                        buffer = _f.sent();
                        keyBase64 = convertArrayBufferToBase64(buffer);
    ...
    WebCrypto.prototype.downloadFile = function (currentFile, oneTimeToken, activationKey, signal, endpoint, dispatch, successfullyDecryptedCallback) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, sha3_hash, iv, clientsideKeySha3Hash, slug, chunkCountResponse, res, count, chunks, chunksStream, Readable, index, encryptedChunk, decryptedChunk, file;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, downloadChunk(index, clientsideKeySha3Hash || sha3_hash, slug, oneTimeToken, signal, endpoint)];
                    case 4:
                        encryptedChunk = _b.sent();
                        return [4 /*yield*/, decryptChunk(encryptedChunk, iv, activationKey)];
                    case 5:
                        decryptedChunk = _b.sent();
                        if (decryptedChunk === null || decryptedChunk === void 0 ? void 0 : decryptedChunk.failed) {
                            return [2 /*return*/, { failed: true }];
                        }
    ...
    WebCrypto.prototype.encodeExistingFile = function (file, dispatch, getFileContent, encryptExistingFileCallback, catchErrorCallback, updateFilePropertyCallback, getImagePreviewEffect, getKeysByWorkspace, updateProgressCallback, saveEncryptedFileKeys, getOneTimeToken) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var fileBlob, arrayBuffer, chunks, fileSignal, thumbnail, hasThumbnail, _b, oneTimeToken, endpoint, keys, startTime, base64iv, key, totalProgress, data, _loop_2, this_2, _i, chunks_2, chunk, e_2, responseFromIpfs, buffer, text_1, encryptedKeys, isCancelModalOpen, _c, thumbToken_1, thumbEndpoint_1, fileName_1, e_3;
            return __generator(this, function (_d) {
                switch (_d.label) {
                        ...
                        _loop_2 = function (chunk) {
                            ...
                            return __generator(this, function (_e) {
                                switch (_e.label) {
                                    case 0:
                                        currentIndex = chunks.findIndex(function (el) { return el === chunk; });
                                        return [4 /*yield*/, encryptChunk(chunk, this_2.iv, key)];
                                    case 1:
                                        encryptedChunk = _e.sent();
                                        return [4 /*yield*/, swapChunk(file, endpoint, base64iv, this_2.clientsideKeySha3Hash, currentIndex, chunks.length - 1, oneTimeToken, encryptedChunk, arrayBuffer, startTime, dispatch, totalProgress, updateProgressCallback)];
                                    case 2:
                                        data = _e.sent();
                                        return [2 /*return*/];
                                }
                    ...
                    case 13:
                        ...
                        return [4 /*yield*/, crypto.subtle.exportKey("raw", hasWindow() ? window.key : global.key)];
                    case 14:
                        buffer = _d.sent();
