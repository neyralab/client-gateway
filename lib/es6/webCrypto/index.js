...
var WebCrypto = /** @class */ (function () {
    ...
    WebCrypto.prototype.encodeFile = function (_a) {
        var _b, _c, _d, _e;
        var file = _a.file, oneTimeToken = _a.oneTimeToken, endpoint = _a.endpoint, getKeysByWorkspace = _a.getKeysByWorkspace, saveEncryptedFileKeys = _a.saveEncryptedFileKeys, getOneTimeToken = _a.getOneTimeToken, callback = _a.callback, handlers = _a.handlers;
        return __awaiter(this, void 0, void 0, function () {
            var startTime, arrayBuffer, chunks, base64Image, result, keys, totalProgress, key, _loop_1, this_1, _i, chunks_1, chunk, state_1, buffer, keyBase64, encryptedKeys, _f, thumbToken, thumbEndpoint, instance, e_1;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 10:
                        ...
                        if (!base64Image) return [3 /*break*/, 12];
